...
require("lazy").setup({
	...
	-- LSP Plugins
	{
		...
		config = function()
			...
			local servers = {
				clangd = {},
				pyright = {},
				-- rust_analyzer managed by rustaceanvim, not here
				texlab = {},
				jsonls = {},
				taplo = {}, -- TOML
				neocmake = {},
	...
	-- Extra colorschemes for the theme picker (<leader>st)
	{ "catppuccin/nvim", name = "catppuccin", lazy = true }, -- mocha, macchiato, frappe, latte
	{ "rose-pine/neovim", name = "rose-pine", lazy = true }, -- rose-pine, rose-pine-moon, rose-pine-dawn
	{ "rebelot/kanagawa.nvim", lazy = true }, -- kanagawa, kanagawa-wave, kanagawa-dragon, kanagawa-lotus
	{ "EdenEast/nightfox.nvim", lazy = true }, -- nightfox, duskfox, carbonfox, terafox, nordfox
	{ "sainnhe/gruvbox-material", lazy = true },
	{ "ellisonleao/gruvbox.nvim", lazy = true },
	{ "maxmx03/fluoromachine.nvim", lazy = true }, -- synthwave/neon (theme: fluoromachine, retrowave, delta)
	...
	{ -- Highlight, edit, and navigate code
		...
		config = function()
			...
			-- use json parser for jsonc filetype
	...
	-- ============================================================
	-- File navigation: oil.nvim (edit filesystem like a buffer)
	-- ============================================================
	{
		"stevearc/oil.nvim",
	...
	-- ============================================================
	-- Diagnostics panel: trouble.nvim v3
	-- ============================================================
	{
		"folke/trouble.nvim",
		dependencies = { "nvim-tree/nvim-web-devicons" },
	...
	-- ============================================================
	-- Rust: rustaceanvim (manages rust-analyzer LSP itself)
	-- ============================================================
	{
		"mrcjkb/rustaceanvim",
		version = "^6",
	...
	-- ============================================================
	-- C/C++: clangd extensions (AST, type hierarchy, memory usage)
	-- ============================================================
	{
	...
	-- Auto-saves/restores sessions per working directory
	{
	...
	-- LaTeX: vimtex (continuous compilation, inverse search)
	-- ============================================================
	{
		"lervag/vimtex",
		lazy = false,
