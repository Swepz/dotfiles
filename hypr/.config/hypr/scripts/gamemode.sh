...
if [ -f $HOME/.cache/hyprland-wallpapers/gamemode_enabled ]; then
  ...
  hyprctl reload
  rm $HOME/.cache/hyprland-wallpapers/gamemode_enabled
  ...
  touch $HOME/.cache/hyprland-wallpapers/gamemode_enabled
